output "organization_role_users_id" {
  ...
  value       = { for k, v in github_organization_role_user.organization_role_users : k => v.id }
}
output "organization_role_users_login" {
  ...
  value       = { for k, v in github_organization_role_user.organization_role_users : k => v.login }
}
output "organization_role_users_role_id" {
  ...
  value       = { for k, v in github_organization_role_user.organization_role_users : k => v.role_id }
}
